    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-12 px-6 md:px-12 bg-surface border-y border-white/5">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          <div
            className="p-8 rounded-2xl bg-accent text-primary flex flex-col items-center text-center gap-4 shadow-lg shadow-accent/10"
          >
            ...
            <div className="flex flex-col gap-2.5 w-full mt-2">
              <a
                ...
                className="px-4 py-2.5 rounded-xl bg-primary/10 hover:bg-primary/20 transition-colors font-mono font-bold text-sm block text-center"
              >
          ...
          <div
            className="p-8 rounded-2xl bg-primary border border-white/10 flex flex-col items-center text-center gap-4 hover:border-white/20 transition-colors"
          >
            ...
            <div className="flex flex-col gap-2.5 w-full mt-2">
              <a
                ...
                className="px-4 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-colors font-mono text-gray-300 text-sm block text-center"
              >
                Line 1: {personalInfo.formattedPhone}
              </a>
              <a
